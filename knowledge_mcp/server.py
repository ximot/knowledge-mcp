...
class KnowledgeSearchInput(BaseModel):
    ...
    tags: Optional[List[str]] = Field(
        default=None, description="Filter by tags (AND logic)", max_length=10
    )
...
class KnowledgeAddInput(BaseModel):
    ...
    title: str = Field(
        ..., description="Title of the knowledge entry", min_length=1, max_length=200
    )
    content: str = Field(
        ..., description="Main content of the knowledge entry", min_length=1, max_length=50000
    )
    knowledge_type: KnowledgeType = Field(
        default=KnowledgeType.NOTE, description="Type of knowledge entry"
    )
    tags: List[str] = Field(
        default_factory=list, description="Tags for categorization", max_length=20
    )
    source: Optional[str] = Field(
        default=None, description="Source of the knowledge (URL, book, etc.)", max_length=500
    )
...
class KnowledgeUpdateInput(BaseModel):
    ...
    id: str = Field(..., description="ID of the knowledge entry to update", min_length=1)
    title: Optional[str] = Field(
        default=None, description="New title (leave empty to keep current)", max_length=200
    )
    content: Optional[str] = Field(
        default=None, description="New content (leave empty to keep current)", max_length=50000
    )
    knowledge_type: Optional[KnowledgeType] = Field(
        default=None, description="New type (leave empty to keep current)"
    )
    tags: Optional[List[str]] = Field(
        default=None, description="New tags (replaces existing)", max_length=20
    )
    source: Optional[str] = Field(default=None, description="New source", max_length=500)
    metadata: Optional[Dict[str, Any]] = Field(
...
class KnowledgeDeleteInput(BaseModel):
    ...
    id: str = Field(..., description="ID of the knowledge entry to delete", min_length=1)
...
class KnowledgeListInput(BaseModel):
    ...
    offset: int = Field(default=0, description="Number of entries to skip", ge=0)
    knowledge_type: Optional[KnowledgeType] = Field(default=None, description="Filter by type")
...
class KnowledgeGetInput(BaseModel):
    ...
    id: str = Field(..., description="ID of the knowledge entry", min_length=1)
    response_format: ResponseFormat = Field(
        default=ResponseFormat.MARKDOWN, description="Output format"
    )
...
class SkillSearchInput(BaseModel):
    ...
    query: str = Field(..., description="Search query for skills", min_length=1, max_length=500)
...
class SkillGetInput(BaseModel):
    ...
    name: str = Field(..., description="Exact name of the skill", min_length=1, max_length=100)
...
class SkillAddInput(BaseModel):
    ...
    description: str = Field(
        ..., description="Short description of what this skill does", min_length=1, max_length=500
    )
    prompt: str = Field(
        ...,
    ...
    version: str = Field(default="1.0.0", description="Version string", max_length=20)
    examples: Optional[List[str]] = Field(
        default=None, description="Example use cases or prompts", max_length=10
    )
...
class SkillUpdateInput(BaseModel):
    ...
    name: str = Field(..., description="Name of the skill to update", min_length=1, max_length=100)
    description: Optional[str] = Field(default=None, description="New description", max_length=500)
    prompt: Optional[str] = Field(default=None, description="New prompt content", max_length=100000)
    tags: Optional[List[str]] = Field(default=None, description="New tags", max_length=20)
    version: Optional[str] = Field(default=None, description="New version", max_length=20)
    examples: Optional[List[str]] = Field(default=None, description="New examples", max_length=10)
...
class SkillDeleteInput(BaseModel):
    ...
    name: str = Field(..., description="Name of the skill to delete", min_length=1, max_length=100)
...
class ProjectSearchInput(BaseModel):
    ...
    query: str = Field(..., description="Search query for projects", min_length=1, max_length=500)
    limit: int = Field(default=5, description="Maximum results", ge=1, le=20)
...
class ProjectAddInput(BaseModel):
    ...
    path: Optional[str] = Field(
        default=None, description="Path to project directory", max_length=500
    )
    description: str = Field(
        ..., description="Short description of the project", min_length=1, max_length=1000
    )
    ...
    metadata: Optional[Dict[str, Any]] = Field(
        default=None, description="Additional metadata (tech stack, links, etc.)"
    )
...
class ProjectGetInput(BaseModel):
    ...
    name: str = Field(..., description="Exact name of the project", min_length=1, max_length=100)
    response_format: ResponseFormat = Field(
        default=ResponseFormat.MARKDOWN, description="Output format"
    )
...
class ProjectUpdateInput(BaseModel):
    ...
    name: str = Field(
        ..., description="Name of the project to update", min_length=1, max_length=100
    )
    path: Optional[str] = Field(default=None, description="New path", max_length=500)
    description: Optional[str] = Field(default=None, description="New description", max_length=1000)
...
class ProjectDeleteInput(BaseModel):
    ...
    name: str = Field(
        ..., description="Name of the project to delete", min_length=1, max_length=100
    )
...
class ProjectListInput(BaseModel):
    ...
    limit: int = Field(default=20, description="Maximum number of projects to return", ge=1, le=100)
    offset: int = Field(default=0, description="Number of projects to skip", ge=0)
...
class PrivateSearchInput(BaseModel):
    ...
    limit: int = Field(default=5, description="Maximum results", ge=1, le=20)
    private_type: Optional[PrivateType] = Field(default=None, description="Filter by type")
    tags: Optional[List[str]] = Field(default=None, description="Filter by tags")
    response_format: ResponseFormat = Field(
        default=ResponseFormat.MARKDOWN, description="Output format"
    )
...
class PrivateAddInput(BaseModel):
    ...
    title: str = Field(..., description="Title of the private entry", min_length=1, max_length=200)
    content: str = Field(
        ..., description="Content of the private entry", min_length=1, max_length=50000
    )
    private_type: PrivateType = Field(default=PrivateType.NOTE, description="Type of private data")
    tags: List[str] = Field(
        default_factory=list, description="Tags for categorization", max_length=20
    )
...
class PrivateGetInput(BaseModel):
    ...
    id: str = Field(..., description="ID of the private entry", min_length=1)
    response_format: ResponseFormat = Field(
        default=ResponseFormat.MARKDOWN, description="Output format"
    )
...
class PrivateUpdateInput(BaseModel):
    ...
    id: str = Field(..., description="ID of the entry to update", min_length=1)
    title: Optional[str] = Field(default=None, description="New title", max_length=200)
    content: Optional[str] = Field(default=None, description="New content", max_length=50000)
    private_type: Optional[PrivateType] = Field(default=None, description="New type")
    tags: Optional[List[str]] = Field(default=None, description="New tags", max_length=20)
    metadata: Optional[Dict[str, Any]] = Field(
        default=None, description="New metadata (merges with existing)"
    )
...
class PrivateDeleteInput(BaseModel):
    ...
    id: str = Field(..., description="ID of the entry to delete", min_length=1)
...
def format_skill_md(skill: Dict[str, Any], include_prompt: bool = True) -> str:
    ...
    if include_prompt and skill.get("prompt"):
        lines.extend(["", "---", "### Prompt", "```", skill["prompt"], "```"])
...
async def knowledge_search(params: KnowledgeSearchInput) -> str:
    ...
    try:
        ...
        results = await qdrant.search(
            collection="knowledge", vector=query_embedding, limit=params.limit, filters=filters
        )
...
async def knowledge_add(params: KnowledgeAddInput) -> str:
    ...
    try:
        ...
        content_hash = hashlib.sha256(f"{params.title}{params.content}".encode()).hexdigest()[:12]
...
async def knowledge_list(params: KnowledgeListInput) -> str:
    ...
    try:
        ...
        results, total = await qdrant.list_all(
            collection="knowledge", limit=params.limit, offset=params.offset, filters=filters
        )
...
async def skill_search(params: SkillSearchInput) -> str:
    ...
    try:
        ...
        results = await qdrant.search(
            collection="skills", vector=query_embedding, limit=params.limit
        )
...
async def skill_get(params: SkillGetInput) -> str:
    ...
    """
    try:
        skill = await qdrant.get_by_field(collection="skills", field="name", value=params.name)
...
async def skill_add(params: SkillAddInput) -> str:
    ...
    try:
        ...
        existing = await qdrant.get_by_field(collection="skills", field="name", value=params.name)
        if existing:
...
async def skill_update(params: SkillUpdateInput) -> str:
    ...
    try:
        ...
        await qdrant.upsert(
            collection="skills", id=existing["id"], vector=embedding, payload=updated
        )
...
async def skill_list(params: SkillListInput) -> str:
    ...
    try:
        ...
        results, total = await qdrant.list_all(
            collection="skills", limit=100, offset=0, filters=filters
        )
        ...
        if params.response_format == ResponseFormat.JSON:
            ...
            for r in results:
                r.pop("prompt", None)
            return json.dumps({"total": total, "skills": results}, indent=2, default=str)
...
async def project_search(params: ProjectSearchInput) -> str:
    ...
    try:
        ...
        results = await qdrant.search(
            collection="projects", vector=query_embedding, limit=params.limit, filters=filters
        )
...
async def project_add(params: ProjectAddInput) -> str:
    ...
    try:
        ...
        existing = await qdrant.get_by_field(collection="projects", field="name", value=params.name)
        if existing:
...
async def project_get(params: ProjectGetInput) -> str:
    ...
    """
    try:
        project = await qdrant.get_by_field(collection="projects", field="name", value=params.name)
...
async def project_list(params: ProjectListInput) -> str:
    ...
    try:
        ...
        results, total = await qdrant.list_all(
            collection="projects", limit=params.limit, offset=params.offset, filters=filters
        )
...
async def private_search(params: PrivateSearchInput) -> str:
    ...
    try:
        ...
        results = await qdrant.search(
            collection="private", vector=query_embedding, limit=params.limit, filters=filters
        )
...
async def private_add(params: PrivateAddInput) -> str:
    ...
    try:
        ...
        return (
            f"Private entry added successfully!\n\n**ID:** `{entry_id}`\n**Title:** {params.title}"
        )
...
async def private_list(params: PrivateListInput) -> str:
    ...
    try:
        ...
        results, total = await qdrant.list_all(
            collection="private", limit=params.limit, offset=params.offset, filters=filters
        )
